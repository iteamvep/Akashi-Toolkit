...
public class QuestAdapter extends BaseBookmarkRecyclerAdapter<QuestViewHolder, Quest> {
    ...
    private void setRewardText(QuestViewHolder holder, int position, int id) {
    ...
    private void addUnlockQuestViews(QuestViewHolder holder, List<String> ids, String format) {
        for (String code : ids) {
            if (code.length() == 0) {
                continue;
            }
