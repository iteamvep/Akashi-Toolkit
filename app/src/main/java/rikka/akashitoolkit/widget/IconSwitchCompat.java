...
/**
 * Created by Rikka on 2016/5/13.
 */
public class IconSwitchCompat extends CompoundButton {
     ...
     */
    public IconSwitchCompat(Context context, AttributeSet attrs) {
    ...
    public IconSwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a = TintTypedArray.obtainStyledAttributes(context,
                attrs, R.styleable.IconSwitchCompat, defStyleAttr, 0);
    ...
    protected boolean verifyDrawable(Drawable who) {
        return super.verifyDrawable(who) || who == mThumbDrawable || who == mTrackDrawable || who == mIconDrawable;
    }
    ...
    public void jumpDrawablesToCurrentState() {
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            if (mIconDrawable != null) {
                mIconDrawable.jumpToCurrentState();
            }
