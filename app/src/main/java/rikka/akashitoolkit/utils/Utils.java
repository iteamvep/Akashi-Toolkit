...
public class Utils {
    ...
    public static String getKCWikiFileUrl(String fileName) {
        ...
        return String.format("https://upload.kcwiki.org/commons/%s/%s/%s", a, b, fileName);
    }
    ...
    public static GlideUrl getGlideUrl(String url) {
        /*return new GlideUrl(url, new LazyHeaders.Builder()
                ...
                .build());*/
        if (url.contains("https://upload.kcwiki.org/")) {
            return new GlideUrl(url, new LazyHeaders.Builder()
                    ...
                    .addHeader("Host", "upload.kcwiki.org")
                    .addHeader("Referer", "https://zh.kcwiki.org/wiki/%E8%88%B0%E5%A8%98%E7%99%BE%E7%A7%91")
                    .build());
        } else {
            return new GlideUrl(url, new LazyHeaders.Builder()
                    .addHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.112 Safari/537.36")
